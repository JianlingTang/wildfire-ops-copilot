...
AUTH_ALLOWED_EMAILS="${AUTH_ALLOWED_EMAILS:?AUTH_ALLOWED_EMAILS is required for production auth allowlist}"
AUTH_ADMIN_EMAILS="${AUTH_ADMIN_EMAILS:-}"
AUTH_REQUIRE_VERIFIED_EMAIL="${AUTH_REQUIRE_VERIFIED_EMAIL:-true}"
