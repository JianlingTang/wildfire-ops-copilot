...
import { badgeForWarning, formatTimestamp } from "./emergency-request/helpers";
import { PendingApprovalsList } from "./emergency-request/PendingApprovalsList";
    ...
    <Card id="emergency-requests-panel" className={cn("flex h-full flex-col border-slate-200 shadow-sm", className)}>
      ...
      <CardContent className="flex flex-1 flex-col gap-4">
        ...
        <div className="space-y-2">
          ...
          <PendingApprovalsList actions={pendingActions} run={run} onActionsChange={onActionsChange} />
        </div>
